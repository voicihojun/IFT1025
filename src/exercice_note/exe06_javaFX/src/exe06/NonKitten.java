...
public class NonKitten extends Case {
    ...
    public NonKitten(char representation) {
        ...
        this.randomImagePath = "/nki/" + randNum + ".png";
        this.description = map.get(this.representation);
    }
    ...
    public static HashMap makeMap() {
        ArrayList<String> aList = getRandomDescription();
        for(int i=58; i < 126; i++) {
            int randomIndex = (int) (Math.random() * aList.size());
            map.put((char) i, aList.get(randomIndex));
    ...
    public static ArrayList getRandomDescription() {
