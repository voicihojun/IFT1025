...
public class NonKitten extends Case {
    ...
    private static HashMap<Character, String> descriptionMap = new HashMap<>();
    HashMap<Character, String> aMap= makeDescriptionMap();
    ...
    public NonKitten() {
        ...
        this.description = descriptionMap.get(this.representation);
    ...
    public void interagir(Robot robot, Controleur c) {
        c.setDescription(aMap.get(this.representation));
    }

    public ArrayList<String> initDescriptionList() {
    ...
    public HashMap<Character,String> makeDescriptionMap() {
        ArrayList<String> aList =initDescriptionList();

        for(int i=58; i < 126; i++) {
            int randomIndex = (int)Math.random() * descriptionList.size();
            String randomDesc = aList.get(randomIndex);
            aList.remove(randomIndex);
            descriptionMap.put((char)i, randomDesc);
        }
    ...
    public static String[] descriptions = new String[]{
            ...
            "model.Empty jewelboxes litter the landscape.",
            ...
            "It's \"Chicken Soup for the model.Kitten-seeking Soulless model.Robot.\"",
            ...
            "It's a copy of \"Zen and The Art of model.Robot Maintenance\".",
            ...
            "It's a DVD of \"Crouching Monkey, Hidden model.Kitten\", region encoded for the moon.",
            ...
            "model.Kitten is the letter 'Q'.  Oh, wait, maybe not.",
            ...
            "Werner's \"Pocket Field Guide to Things That Are Not model.Kitten\".",
            "You found nettik, but that's backwards.",
            "You have found some zinc, but you must not stop here, for you must find kitten.\", ",
            "\"50 Years Among the Non-model.Kitten Items\", by Ann Droyd.",
            "\"model.Robot may not injure kitten, or, through inaction, ...\"",
            ...
            "\"201 model.Kitten Verbs, Fully Conjugated\".  You look for \"find\".",
            ...
            "No kitten here.",
            "The score for a Czech composer's \"model.Kitten-Finding Symphony in C\".",
            ...
            "model.Robot should not be touching that.",
